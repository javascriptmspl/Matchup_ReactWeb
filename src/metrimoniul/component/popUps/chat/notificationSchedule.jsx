      ...
      <div className="main" style={{ position: "relative" }}>
        ...
        <div className="svg-top " >
          ...
          <div className="upperData matched-modal">
            <h3 style={{ zIndex: "99999" }}>You’ressss Matched</h3>
            <p>You and Desirae have both liked each other</p>
            <div className="coll row">
              <div className="col-md-8 mod-person-lft col-8">
                <p className="fs-4 text-muted fw-600 per-txt">{LoginUser?.userName}</p>
                <p className="fs-4 text-muted fw-600 per-dest"> {LoginUser?.occupation}</p>
            ...
            <div className="row rt2">
              <div className="col-md-4 col-4">
                <img
                  className="img2" style={{
                    borderRadius: '50%',

                  }}
                  src={selectUser?.avatar} alt=""
                />
              </div>
              <div className="col-md-8 mod-person-rt col-8">
                <p className="fs-4 text-muted fw-600 per-txt">{selectUser?.name}</p>
                <p className="fs-4 text-muted fw-600 per-dest">{selectUser?.profession}</p>
                <p className="fs-4 text-muted fw-600 location">
          ...
          <div className="main-bottom">
            ...
            <Link >
              <button onClick={() => { calenderScheduleDAte() }} className="schedule-date" >
...
export default NotificationScheduleMetri;
