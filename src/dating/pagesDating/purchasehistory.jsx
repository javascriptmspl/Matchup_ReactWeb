  ...
  const fetchPurchaseHistory = async (pageNo = 1) => {
    ...
    try {
      ...
      if (response.isSuccess && response.data) {
        ...
        // Calculate balance from purchases first (this is more reliable)
        calculateBalanceFromPurchases();
        // Then try to get updated balance from API
        setTimeout(() => {
        ...
        setPurchases([]);
        // Don't reset coin balance here as it's fetched separately
      }
    } catch (error) {
